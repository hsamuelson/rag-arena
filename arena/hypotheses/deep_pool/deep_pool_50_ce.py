"""Deep pool 50: push the recall frontier further.

Deep pool 30 gave +6.1% (p<0.0001). Does 50 give even more?
"""
...
class DeepPool50CEHypothesis(Hypothesis):
    """Retrieve top-50 candidates, CE rerank to top-10."""
